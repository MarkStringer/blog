#Mark Stringer – Agile Coach, Scrum Master and Trainer
##SUMMARY
* **Agile Coach**: coaching teams and organisations through Agile transformations to high-performing Agile maturity.
* **Scrum Master**: facilitating the Agile development process, initiating and sustataining an high-functioning Agile team.
* **Trainer**: authoring and delivering compelling and memborable Agile training courses.

##SKILLS
Agile, Scrum, Lean, implmentation of TDD - Test Driven Development and CI - Continuous Integration (GitHub, Git, Gherkin, Cucumber, JUnit, Selenium, Jenkins). Authoring and delivering training to a syllabus for certification. Agile at scale methodologies - SAFE, LeSS, DAD.

##EMPLOYMENT
###Sopra Group Ltd (January ’14 – Present)
...
Day-to-day management of software development by 30 developers; reporting on project progress to senior management and planning releases of future work.  Development was in a Java environment using pair programming, TDD and CI all project management was done using JIRA the suite of tools, including Greenhopper.
...
####Nixon McInnes
I worked with Nixon McInnes to improve Agile working methods through initial story extraction meetings; through development iterations and through  successful re-negotiations of scope. 
Courses delivered to clients include: Test Driven Development, Introduction to Lean and Kanban, Introduction to Agile, Working as a Product Owner with an Agile Team.
...
* UK Driving Licence
##INTERESTS
My most recent project is a series of “Agile Koan” as part of my ongoing Agile Blog at  (http://www.mumbly.co.uk/newblog/). 
